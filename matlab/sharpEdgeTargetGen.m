...
cfgFile = '2015_12_23_prodUnitsTest_v26_centers.xml';
cfgPath = 'C:\Users\cmorantz\Dropbox\PFS_EM\TEST_RESULTS\TargetConvergenceEMDowns\16_04_26_18_04_12_msimCenters\';

CobraConfig = loadCfgXml(cfgPath,cfgFile);

Npid = length(CobraConfig.ARM_DATA.ARM_DATA_CONTAINER);

% GROUP C
activeCobras = [7,13,19,25,31,37,43,49,55];
...
phiAngle = 45;
thtAngleStill = [89.06,90.94,76.78,74.84,83.62,15.54,-15.54];
thtAngleActv = 0;
